...
from improved_sdd_cli import app, AI_TOOLS, APP_TYPES
...
class TestInitCommand:
    ...
    @patch('improved_sdd_cli.create_project_structure')
    @patch('improved_sdd_cli.show_banner')
    def test_init_new_directory_exists(
        self,
        mock_banner,
        mock_create_structure,
        runner: CliRunner,
...
class TestDeleteCommand:
    ...
    @patch('improved_sdd_cli.input')
    @patch('improved_sdd_cli.show_banner')
    def test_delete_interactive_app_type_selection(
        self,
        mock_banner,
        mock_input,
        runner: CliRunner,
    ...
    @patch('improved_sdd_cli.show_banner')
    def test_delete_no_files_found(
        self,
        mock_banner,
        runner: CliRunner,
        temp_dir: Path
    ...
    @patch('improved_sdd_cli.show_banner')
    def test_delete_files_with_force(
        self,
        mock_banner,
        runner: CliRunner,
        project_with_existing_files: Path
...
class TestMainApp:
    ...
    @patch('improved_sdd_cli.show_banner')
    def test_app_no_command_shows_banner(
        self,
        mock_banner,
        runner: CliRunner
    ):
