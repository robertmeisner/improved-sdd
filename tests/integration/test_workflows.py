...
from improved_sdd_cli import app, create_project_structure, FileTracker
...
class TestProjectStructureCreation:
    ...
    def test_create_project_structure_python_cli(
        self,
    ...
    def test_create_project_structure_mcp_server(
        self,
        temp_project_dir: Path,
        mock_templates_dir: Path
    ):
    ...
    def test_create_project_structure_template_customization(
        self,
        temp_project_dir: Path,
        mock_templates_dir: Path
    ):
    ...
    def test_create_project_structure_multiple_ai_tools(
        self,
        temp_project_dir: Path,
        mock_templates_dir: Path
    ):
...
class TestFullSystemIntegration:
    ...
    def test_error_handling_missing_templates(
        self,
        runner: CliRunner,
        temp_dir: Path
    ):
